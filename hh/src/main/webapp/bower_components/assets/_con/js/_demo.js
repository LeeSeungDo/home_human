            ...
            switch(n) {
              ...
              case 'Color':
                if(value == 'Light') {
                  ...
                  this.sidebarLogo.src = '../../images/hhlogo.png';
                } else {
                  this.sidebarLogo.src = '../../images/hhlogo.png';
                }
                break;
          ...
          for(var n in this.options[k]) {
            ...
            switch(n) {
              case 'Color':
                ...
                if(value == 'blue') {
                  this.styles.setAttribute("href", '../../bower_components/assets/_con/css/con-base.min.css');
                } else {
                  this.styles.setAttribute("href", '../../bower_components/assets/_con/css/con-' + value + '.min.css');
                }
                break;
