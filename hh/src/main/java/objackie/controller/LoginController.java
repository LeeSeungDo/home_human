...
@Controller
@RequestMapping("/auth/")
@SessionAttributes({ "member" }) // Model 객체에 저장된 정보 중에서 로그인 회원 정보는 따로 세션으로
                                 // 관리한다.
public class LoginController {
  ...
  public Object login(HttpSession session, /* 세션이 무효화된 이후에 세션을 자동 생성하도록 강제한다. */
      HttpServletResponse response, String email, String password, boolean saveEmail, Model model,
