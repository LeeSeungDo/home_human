...
public class NoticeController {
  ...
  public String list(
    ...
    try {
      ...
      List<Notice> list = noticeDao.selectList(map);
  ...
  public String update(Notice notice) throws Exception {
    ...
    try {
      ...
      paramMap.put("no", notice.getNo());
      paramMap.put("password", notice.getPassword());
      
      if (noticeDao.selectOneByPassword(paramMap) == null) {
